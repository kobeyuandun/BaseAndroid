package com.android.photocameralib.media.widget;
...
public class ImagePreviewView extends ImageView {
    ...
    public ValueAnimator.AnimatorUpdateListener getOnScaleAnimationUpdate() {
        if (onScaleAnimationUpdate != null) {
    ...
    public ValueAnimator.AnimatorUpdateListener getOnTranslateXAnimationUpdate() {
        if (onTranslateXAnimationUpdate != null) {
    ...
    public ValueAnimator.AnimatorUpdateListener getOnTranslateYAnimationUpdate() {
        if (onTranslateYAnimationUpdate != null) {
    ...
    private float getDiffX() {
        ...
        return translateLeft >= 0 ? translateLeft : getWidth() - translateLeft - mScaledWidth > 0 ? -(getWidth() - translateLeft - mScaledWidth) : 0;
    }
    ...
    private float getDiffY() {
        ...
        return translateTop >= 0 ? translateTop : getHeight() - translateTop - mScaledHeight > 0 ? -(getHeight() - translateTop - mScaledHeight) : 0;
    }
    ...
    protected boolean setFrame(int l, int t, int r, int b) {
        ...
        if (mBoundWidth != 0 && mBoundHeight != 0 && scale != 1) {
            return false;
        }
    ...
    private class ScaleListener
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (mOldScaledWidth > getWidth() && getDiffX() != 0 || (mOldScaledHeight > getHeight() && getDiffY() != 0)) {
                return false;
            }
