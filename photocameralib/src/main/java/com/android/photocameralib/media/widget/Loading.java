...
public class Loading extends View {
    ...
    public void setProgressStyle() {
        ...
        drawable = new LoadingCircleDrawable(resources.getDimensionPixelOffset(R.dimen.g_loading_minSize), resources
                .getDimensionPixelOffset(R.dimen.g_loading_maxSize));
